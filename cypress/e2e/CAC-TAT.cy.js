describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('marca cada tipo de atendimento', () => {
    cy.get('input[type="radio"')
      .each((typeOfservice) => { // encontra os elementos do tipo
        cy.wrap(typeOfservice) // empacota os elementos para dar o comando a todos eles
          .check()
          .should('be.checked')
      })
  })
  ...
  it('verifica que a política de privacidade abre em outra aba sem a necessidade de um clique', () => {
    cy.contains('a', 'Política de Privacidade') // Usa o contains por se tratar de uma tag rasa
      .should('have.attr', 'href', 'privacy.html')
      .and('have.attr', 'target', '_blank')
  })

  it('acessa a página da política de privacidade removendo o target e então clicando no link', () => {
    cy.contains('a', 'Política de Privacidade') // Usa o contains por se tratar de uma tag rasa para pegar o seu coneudo
